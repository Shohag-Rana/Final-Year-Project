...
EXCLUDED_APPS = ["django", "crispy_forms", "whitenoise"]
choices = [
    (app, app)
    for app in settings.INSTALLED_APPS
    if not any(app.startswith(excluded) for excluded in EXCLUDED_APPS)
]
choices.append(("test_case_run", "test_case_run"))

class Sample(models.Model):
    test = models.CharField(choices=choices, max_length=200)